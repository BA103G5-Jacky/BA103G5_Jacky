...
public class MilestoneDAO implements MilestoneDAO_interface{
	...
	private static final String UPDATE_AGREE = 
			"UPDATE milestone set  MILESTONESTATE=? where MILESTONENO = ?";
	private static final String GET_ONE_MILESTONE = "select * from milestone where csno=? order by MILESTONENO desc ";
