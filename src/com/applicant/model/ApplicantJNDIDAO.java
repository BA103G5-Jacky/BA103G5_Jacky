...
public class ApplicantJNDIDAO implements ApplicantDAO_interface{
...
//	private String hirerNo;
	...
	//private static final String UPDATE_STMT = "update Applicant set csNO=?, freelancerNo=?, hirerNo=? where csNO=? and freelanceNO=?";
	...
	public static void main(String[] args) {
		...
		ApplicantJNDIDAO dao = new ApplicantJNDIDAO();
