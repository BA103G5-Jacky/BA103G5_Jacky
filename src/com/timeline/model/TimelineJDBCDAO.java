...
public class TimelineJDBCDAO implements TimelineDAO_interface {
	...
	public static final String GET_ALL_STMT = "SELECT noteNo, noteTitle, noteContent, csNo, "
			+ "to_char(UPLOADEDATE,'yyyy-mm-dd') UPLOADEDATE, to_char(RECORDDATE,'yyyy-mm-dd')  RECORDDATE, "
	...
	public void insert(TimelineVO timelineVO) {
		...
		try {
			...
			pstmt.setDate(4, timelineVO.getUploadDate());
	...
	public List<TimelineVO> getAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				timelineVO.setUploadDate(rs.getDate("UPLOADEDATE"));
...
//
		...
		System.out.print(timelineVO3.getUploadDate() + ",");
...
//			System.out.print(aTimeline.getUploadDate() + ",");
